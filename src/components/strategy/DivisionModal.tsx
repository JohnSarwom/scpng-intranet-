                                    ...
                                    <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col overflow-hidden min-h-0">
                                        ...
                                        <div className="flex-1 overflow-y-auto p-8 custom-scrollbar relative">
                                            ...
                                            <TabsContent value="overview" className="m-0 focus-visible:outline-none max-w-3xl">
                                                <div className="mb-8">
                                                    <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight leading-tight">{currentData.divisionName}</h2>
                                                    <p className="text-[#800020] font-bold text-sm uppercase tracking-wider mt-2">{currentData.branch}</p>
                                                </div>
                                                ...
                                                <div className="mb-12">
                                                    <div className="flex items-center gap-3 mb-4">
                                                        <div className="w-1 h-6 bg-[#800020] rounded-full"></div>
                                                        <h4 className="text-lg font-bold text-gray-900">Sub-departments</h4>
                                                    </div>
                                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                        {currentData.subDepartments.map((dept, idx) => (
                                                            <div key={idx} className="bg-gray-50 border border-gray-100 rounded-xl p-4 flex items-start gap-4 hover:border-gray-200 transition-colors hover:shadow-sm">
                                                                ...
                                                                <div>
                                                                    <h5 className="font-semibold text-gray-900 text-sm mb-1">{dept.name}</h5>
                                                                    <p className="text-xs text-gray-500 leading-snug">{dept.description}</p>
                                                                </div>
                                                            </div>
                                                        ))}
                                                    </div>
