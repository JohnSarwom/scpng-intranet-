...
const LeaveApplicationPaper: React.FC = () => {
  ...
  return (
    <div style={{ fontFamily: '\'Times New Roman\', Times, serif', width: '800px', margin: '20px auto', padding: '20px', fontSize: '14px', lineHeight: '1.2', border: '1px solid #ccc' }}>
      ...
      <div style={{ marginTop: '30px', display: 'flex', justifyContent: 'center', paddingBottom: '20px' }}>
        <Button
          type="submit"
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.backgroundColor = '#8B2C33';
            e.currentTarget.style.transform = 'translateY(-2px)';
            e.currentTarget.style.boxShadow = '0 4px 8px rgba(0,0,0,0.2)';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.backgroundColor = '#6B1C23';
