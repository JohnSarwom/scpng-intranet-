...
- **PaymentsSharePointService** (16 connections) — `src\services\paymentsSharePointService.ts`
- **.updatePayment()** (8 connections) — `src\services\paymentsSharePointService.ts`
...
- **.deletePayment()** (2 connections) — `src\services\paymentsSharePointService.ts`
- **.restorePayment()** (2 connections) — `src\services\paymentsSharePointService.ts`
- **.approvePayment()** (2 connections) — `src\services\paymentsSharePointService.ts`
- **.rejectPayment()** (2 connections) — `src\services\paymentsSharePointService.ts`
...
- `src\services\paymentsSharePointService.ts`
