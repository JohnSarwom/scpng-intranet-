          ...
          <div className="grid gap-6">
            <div className="grid gap-2">
              ...
              <Input
                ...
                aiAssist={{ mode: 'title', context: 'project name', onApply: (v) => handleChange('name', v) }}
              />
            </div>
            <div className="grid gap-2">
              ...
              <Textarea
                ...
                aiAssist={{ mode: ['polish', 'grammar', 'expand'], context: 'project description', onApply: (v) => handleChange('description', v) }}
              />
            </div>
