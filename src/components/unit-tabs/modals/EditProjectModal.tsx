        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="grid gap-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <GlobalAssigneeSelector
                  selected={editedProject.manager ? [{
                    id: editedProject.manager, // Using name as ID for now since that's how it's stored
                    displayName: editedProject.manager,
                    givenName: editedProject.manager.split(' ')[0] || '',
                    surname: editedProject.manager.split(' ').slice(1).join(' ') || '',
                    mail: '', // Not strictly needed for display if displayName is set
                  }] : []}
                  onChange={(employees) => {
              ...
              <div className="flex flex-col gap-2">
                <Label htmlFor="project-assignees">Additional Assignees</Label>
                <GlobalAssigneeSelector
