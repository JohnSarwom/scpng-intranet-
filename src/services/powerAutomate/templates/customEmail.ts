export function buildCustomEmailTemplate(): string {
...
<td align="right">
<span style="display:inline-block;font-size:13px;color:#ffffff;background:rgba(255,255,255,0.15);padding:5px 12px;border-radius:4px;">@{formatDateTime(outputs('Compute_Custom_Start'), 'dd MMM yyyy')} - @{formatDateTime(outputs('Compute_Custom_End'), 'dd MMM yyyy')}</span>
</td>
</tr>
</table>
</td></tr>
...
<div style="width:46px;height:46px;border-radius:10px;background:#800020;color:#ffffff;font-size:16px;text-align:center;line-height:46px;font-weight:700;box-shadow:0 4px 8px rgba(128,0,32,0.2);">C</div>
</td>
<td valign="top" style="padding-left:14px;">
<p style="margin:0 0 3px 0;font-size:14px;font-weight:600;color:#333;">Custom Date Range Performance</p>
...
<p style="margin:0 0 8px 0;font-size:11px;font-weight:700;color:#888;text-transform:uppercase;border-bottom:1px solid #eee;padding-bottom:5px;">Task Volume</p>
...
@{if(greater(length(string(outputs('Extract_AI_Response'))), 2), concat('<table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff;border:1px solid #e0e0e0;border-top:none;"><tr><td style="padding:0 24px 22px 24px;border-top:2px dashed #eee;"><table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:22px;"><tr><td style="font-size:15px;font-weight:700;color:#800020;padding-bottom:12px;">Custom Range Analysis <span style="display:inline-block;background:#800020;color:#fff;font-size:9px;padding:2px 6px;border-radius:3px;margin-left:6px;vertical-align:middle;letter-spacing:0.5px;">GEMINI AI</span></td></tr></table><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#fcfcfc;border:1px solid #eee;border-left:4px solid #0052cc;border-radius:8px;"><tr><td style="padding:14px 15px;font-size:13px;color:#444;line-height:1.6;border-bottom:1px solid #eee;">', replace(string(outputs('Extract_AI_Response')), '||INSIGHT||', '</td></tr><tr><td style="padding:14px 15px;font-size:13px;color:#444;line-height:1.6;border-bottom:1px solid #eee;">'), '</td></tr></table></td></tr></table>'), '')}
