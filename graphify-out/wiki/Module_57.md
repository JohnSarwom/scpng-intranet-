...
- **transformAnnouncement()** (1 connections) — `src\services\announcementsSharePointService.ts`
- **.constructor()** (1 connections) — `src\services\announcementsSharePointService.ts`
- **getAnnouncements()** (1 connections) — `src\services\announcementsSharePointService.ts`
...
- `src\services\announcementsSharePointService.ts`
