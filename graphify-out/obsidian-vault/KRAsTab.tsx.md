...
- [[handleCloseObjectiveModal()]] - `contains` [EXTRACTED]
- [[handleConfirmDeleteKpi()]] - `contains` [EXTRACTED]
- [[handleDeleteKpiClick()]] - `contains` [EXTRACTED]
- [[handleDeleteKra()]] - `contains` [EXTRACTED]
- [[handleDeleteObjective()]] - `contains` [EXTRACTED]
- [[handleFullscreenChange()]] - `contains` [EXTRACTED]
- [[handleKpiFormSubmit()]] - `contains` [EXTRACTED]
- [[handleObjectiveFormChange()]] - `contains` [EXTRACTED]
- [[handleOpenAddKraModal()]] - `contains` [EXTRACTED]
- [[handleOpenAddObjectiveModal()]] - `contains` [EXTRACTED]
- [[handleOpenEditKpiModal()]] - `contains` [EXTRACTED]
- [[handleOpenEditKraModal()]] - `contains` [EXTRACTED]
- [[handleOpenEditObjectiveModal()]] - `contains` [EXTRACTED]
