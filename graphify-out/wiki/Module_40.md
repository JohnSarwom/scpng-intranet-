...
- **UnitService** (10 connections) — `src\services\unitService.ts`
- **.initialize()** (5 connections) — `src\services\unitService.ts`
- **.addUnit()** (4 connections) — `src\services\unitService.ts`
