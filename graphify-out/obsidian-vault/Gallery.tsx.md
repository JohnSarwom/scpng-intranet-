...
- [[handleDeleteSelected()]] - `contains` [EXTRACTED]
- [[handleImageClick()_1]] - `contains` [EXTRACTED]
- [[handlePhotoAdded()]] - `contains` [EXTRACTED]
- [[handlePhotoUpdated()]] - `contains` [EXTRACTED]
- [[handleResize()]] - `contains` [EXTRACTED]
- [[handleSelectPhoto()]] - `contains` [EXTRACTED]
- [[navigateImage()]] - `contains` [EXTRACTED]
- [[openDeleteConfirm()]] - `contains` [EXTRACTED]
